-- ============================================================================
-- COMPLETE DATABASE FIX - Execute All Changes
-- ============================================================================
-- Date: 2025-11-17
-- Safe for: Test environments (all data is test data)
-- Estimated time: 5-10 minutes
-- Rollback: See ROLLBACK_ALL_FIXES.sql
-- ============================================================================

-- ============================================================================
-- PHASE 2: Fix FK Constraints (Critical)
-- ============================================================================

-- Step 2.1: Add missing unique constraint to challenge_progress
-- This constraint should have existed but doesn't
...
-- These are invalid - they reference non-unique columns
...
-- Step 2.3: Add correct composite FK constraints
-- These properly reference the composite unique key
ALTER TABLE flow_completions
