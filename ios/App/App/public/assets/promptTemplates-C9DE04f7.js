function $(m,s=""){var i,l,c,p,d,h,O,g,u,f;const{persona:n,offer:e,validation:a,voice:o,launch:r}=m,t=[];if(t.push(`Create high-converting landing page copy for a lead magnet opt-in page.
...
${n!=null&&n.unique_approach?`- What makes this unique: ${n.unique_approach}`:""}`),(e!=null&&e.leadMagnet||((i=e==null?void 0:e.lead_magnet_ideas)==null?void 0:i.length)>0)&&t.push(`
LEAD MAGNET:
- Type: ${((l=e.leadMagnet)==null?void 0:l.type)||"Free resource"}
- Idea: ${((c=e.leadMagnet)==null?void 0:c.idea)||((p=e.lead_magnet_ideas)==null?void 0:p[0])||"Not specified"}`),((d=a==null?void 0:a.painPoints)==null?void 0:d.length)>0||((h=a==null?void 0:a.pain_points)==null?void 0:h.length)>0){const y=a.painPoints||a.pain_points||[];t.push(`
PAIN POINTS TO ADDRESS (from real customer research):
${y.slice(0,5).map(T=>`- "${T}"`).join(`
`)}`)}if(((O=a==null?void 0:a.dreamOutcomes)==null?void 0:O.length)>0||((g=a==null?void 0:a.desired_outcomes)==null?void 0:g.length)>0){const y=a.dreamOutcomes||a.desired_outcomes||[];t.push(`
...
${((f=o.signature_phrases)==null?void 0:f.length)>0?`- Signature phrases to incorporate: ${o.signature_phrases.slice(0,3).join(", ")}`:""}`),s&&t.push(`
ADDITIONAL CONTEXT:
${s}`),t.push(`
OUTPUT FORMAT:
Please create:
...
`)}function E(m,s=""){var l,c,p,d,h,O,g;const{persona:n,offer:e,validation:a,voice:o,proof:r,launch:t}=m,i=[];if(i.push(`Create a high-converting sales page for my core offer.

GOAL: Convert warm leads into paying customers.`),e&&i.push(`
THE OFFER:
...
${((d=(p=e.scarcity)==null?void 0:p.types)==null?void 0:d.length)>0?`- Urgency/Scarcity: ${e.scarcity.types.join(", ")}`:""}`),(n!=null&&n.ideal_customer||e!=null&&e.niche_definition)&&i.push(`
TARGET AUDIENCE:
- Who: ${(n==null?void 0:n.ideal_customer)||(e==null?void 0:e.niche_definition)||"Not specified"}
- Core Problem: ${(n==null?void 0:n.core_problem)||(e==null?void 0:e.problem_area)||"Not specified"}`),((h=a==null?void 0:a.painPoints)==null?void 0:h.length)>0||((O=a==null?void 0:a.pain_points)==null?void 0:O.length)>0){const u=a.painPoints||a.pain_points||[];i.push(`
PAIN POINTS (use their exact language):
${u.slice(0,7).map(f=>`- "${f}"`).join(`
`)}`)}if(((g=a==null?void 0:a.objections)==null?void 0:g.length)>0&&i.push(`
COMMON OBJECTIONS TO ADDRESS:
${a.objections.slice(0,5).map(u=>`- ${u}`).join(`
`)}`),r!=null&&r.stack||t!=null&&t.proof){const u=(r==null?void 0:r.stack)||(t==null?void 0:t.proof);i.push(`
...
${u.mediaFeatures?`- Media features: ${u.mediaFeatures}`:""}`)}return(o!=null&&o.voice_summary||o!=null&&o.contrarian_takes)&&i.push(`
VOICE & POSITIONING:
${o.voice_summary?`- Tone: ${o.voice_summary}`:""}
${o.contrarian_takes?`- Unique angle: ${o.contrarian_takes}`:""}`),s&&i.push(`
ADDITIONAL CONTEXT:
${s}`),i.push(`
OUTPUT FORMAT:
...
Use emotional storytelling and focus on transformation over features.`),i.join(`
`)}function A(m,s=""){var i,l;const{persona:n,offer:e,validation:a,voice:o,proof:r}=m,t=[];if(t.push(`Create a 5-email nurture sequence to build trust and warm up leads.
...
ENTRY POINT:
They just downloaded: ${e.leadMagnet.idea||e.leadMagnet.type||"a free resource"}`),((i=a==null?void 0:a.painPoints)==null?void 0:i.length)>0||((l=a==null?void 0:a.pain_points)==null?void 0:l.length)>0){const c=a.painPoints||a.pain_points||[];t.push(`
PAIN POINTS TO REFERENCE:
${c.slice(0,5).map(p=>`- "${p}"`).join(`
`)}`)}return o!=null&&o.voice_summary&&t.push(`
VOICE:
Write in this tone: ${o.voice_summary}`),s&&t.push(`
ADDITIONAL CONTEXT:
${s}`),t.push(`
EMAIL STRUCTURE:
...
`)}function _(m,s=""){var l,c,p,d,h,O;const{persona:n,offer:e,validation:a,voice:o,proof:r,launch:t}=m,i=[];return i.push(`Create a 7-email launch sequence to sell my offer.

GOAL: Convert warm leads into buyers during a launch window.
SEQUENCE: 7 emails over 5-7 days`),e&&i.push(`
THE OFFER:
- Name: ${e.name||e.offer_name||"Core Offer"}
...
${(c=e.guarantee)!=null&&c.type?`- Guarantee: ${e.guarantee.type}`:""}`),(((d=(p=e==null?void 0:e.scarcity)==null?void 0:p.types)==null?void 0:d.length)>0||t!=null&&t.approach)&&i.push(`
URGENCY ELEMENTS:
${(h=e==null?void 0:e.scarcity)!=null&&h.types?`- Scarcity: ${e.scarcity.types.join(", ")}`:""}
${t!=null&&t.approach?`- Launch approach: ${t.approach}`:""}`),((O=a==null?void 0:a.objections)==null?void 0:O.length)>0&&i.push(`
OBJECTIONS TO OVERCOME:
${a.objections.slice(0,5).map(g=>`- ${g}`).join(`
`)}`),(r!=null&&r.stack||t!=null&&t.proof)&&i.push(`
PROOF TO INCLUDE:
- Use testimonials and case studies throughout the sequence`),s&&i.push(`
ADDITIONAL CONTEXT:
${s}`),i.push(`
EMAIL STRUCTURE:
...
Make emails urgent but genuine. Focus on transformation and FOMO.`),i.join(`
`)}function P(m,s=""){var t;const{persona:n,offer:e,voice:a,validation:o}=m,r=[];return r.push(`Create cold outreach scripts for reaching new prospects.

GOAL: Start conversations that lead to discovery calls or lead magnet downloads.
PLATFORM: ${s!=null&&s.includes("LinkedIn")?"LinkedIn":s!=null&&s.includes("Instagram")?"Instagram":"Multi-platform (LinkedIn, Instagram, Email)"}`),n!=null&&n.ideal_customer&&r.push(`
...
Keep messages conversational, not salesy. Focus on starting a dialogue.`),r.join(`
`)}function D(m,s={},n=""){var p;const{persona:e,offer:a,voice:o}=m,{name:r,lastInteraction:t,status:i,notes:l}=s,c=[];return c.push(`Create a warm follow-up message for an engaged lead.

GOAL: Re-engage and move them toward the next step.`),c.push(`
CONTACT DETAILS:
- Name: ${r||"[Contact Name]"}
- Last interaction: ${t||"Recently engaged with content"}
- Status: ${i||"Interested but not yet converted"}
${l?`- Notes: ${l}`:""}`),(a!=null&&a.dreamOutcome||a!=null&&a.dream_outcome)&&c.push(`
WHAT I'M OFFERING:
- Outcome: ${a.dreamOutcome||a.dream_outcome}
- Next step: ${(p=a.leadMagnet)!=null&&p.idea?`Free resource: ${a.leadMagnet.idea}`:"Discovery call or consultation"}`),o!=null&&o.voice_summary&&c.push(`
TONE:
...
`)}function N(m,s="facebook",n=""){var l,c,p;const{persona:e,offer:a,validation:o,voice:r}=m,t=[],i={facebook:"Facebook/Instagram Feed Ads",story:"Instagram/Facebook Story Ads",google:"Google Search Ads",youtube:"YouTube Video Ads"};if(t.push(`Create ad copy for ${i[s]||"social media ads"}.
...
${a.dreamOutcome||a.dream_outcome?`- Outcome: ${a.dreamOutcome||a.dream_outcome}`:""}`),((c=o==null?void 0:o.painPoints)==null?void 0:c.length)>0||((p=o==null?void 0:o.pain_points)==null?void 0:p.length)>0){const d=o.painPoints||o.pain_points||[];t.push(`
...
Keep copy punchy and conversational. Use line breaks for readability.`):s==="google"&&t.push(`
OUTPUT FORMAT:
...
`)}const C={landingPage:{id:"landingPage",name:"Landing Page Copy",description:"Lead magnet opt-in pages",icon:"🌐",generator:$,requiredData:["persona","offer"],recommendedData:["validation","voice"]},salesPage:{id:"salesPage",name:"Sales Page Copy",description:"Core offer sales pages",icon:"💰",generator:E,requiredData:["offer"],recommendedData:["persona","validation","voice","proof"]},nurtureSequence:{id:"nurtureSequence",name:"Nurture Sequence",description:"5-email trust-building sequence",icon:"📧",generator:A,requiredData:["persona"],recommendedData:["offer","validation","voice"]},launchSequence:{id:"launchSequence",name:"Launch Sequence",description:"7-email sales sequence",icon:"🚀",generator:_,requiredData:["offer"],recommendedData:["persona","validation","voice","proof","launch"]},coldOutreach:{id:"coldOutreach",name:"Cold Outreach",description:"DM and email scripts",icon:"📤",generator:P,requiredData:["persona"],recommendedData:["offer","voice"]},warmFollowUp:{id:"warmFollowUp",name:"Warm Follow-up",description:"Follow-up messages for engaged leads",icon:"🤝",generator:D,requiredData:[],recommendedData:["offer","voice"]},adCopy:{id:"adCopy",name:"Ad Copy",description:"Social media ad variations",icon:"📣",generator:N,requiredData:["persona"],recommendedData:["offer","validation","voice"]}};function I(m,s){const n=C[m];if(!n)return{ready:!1,missing:[],recommended:[]};const e=n.requiredData.filter(o=>!s[o]),a=n.recommendedData.filter(o=>!s[o]);return{ready:e.length===0,missing:e,recommended:a,completeness:Math.round((n.requiredData.length-e.length+(n.recommendedData.length-a.length)*.5)/(n.requiredData.length+n.recommendedData.length*.5)*100)}}export{C as P,I as c};
