import{r as h,j as n,s as le,u as $e,a as Ie,m as Se}from"./index-CsU49d_5.js";import{e as Ae,h as fe,t as Le,i as ge,I as Pe,j as ke,k as Me}from"./implementationService-B0hwVHU7.js";import{P as ye}from"./ProjectSwitcher-C7zgrQXa.js";import{g as Re,a as qe}from"./businessProfile-vHygctYi.js";function H(e){var a,t,o,r,m,g,u,p,v,b,O;if(!(e!=null&&e.autonomous))return"";const s=[],i=e.autonomous;if(((a=i.revenue)!=null&&a.current||(t=i.revenue)!=null&&t.target)&&s.push(`BUSINESS CONTEXT:
...
`)}`),((b=i.competitors)==null?void 0:b.length)>0||i.yourAdvantage){const T=((O=i.competitors)==null?void 0:O.slice(0,2).map($=>`- ${$.name}: ${$.positioning||"unknown positioning"}${$.pricing?` (~$${$.pricing})`:""}`))||[];s.push(`COMPETITIVE LANDSCAPE:
${T.length>0?T.join(`
...
${(O=(b=(v=e==null?void 0:e.autonomous)==null?void 0:v.customers)==null?void 0:b.best)!=null&&O.buyingTrigger?`5. Tap into this buying trigger: "${e.autonomous.customers.best.buyingTrigger}"`:""}
...
- Upsell goal: ${((b=(v=(p=e==null?void 0:e.offers)==null?void 0:p.upsell)==null?void 0:v.goal)==null?void 0:b.replace(/_/g," "))||"increase revenue"}
...
3. Address the specific objection${((b=(v=(p=(u=e==null?void 0:e.autonomous)==null?void 0:u.customers)==null?void 0:p.worst)==null?void 0:v.objections)==null?void 0:b.length)>0?" (reference their actual objections above)":""}
4. Clear call-to-action
