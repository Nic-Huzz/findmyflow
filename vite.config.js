...
function creatorBrandPlugin() {
  const replacements = [
    ...
    // Meta description
    ['content="Safety × Expression = experiences you love. Vibe Rise gamifies courage, tracks your aliveness, and helps you stack experiences you love until you have a life you love."',
     'content="Where experience creators grow. Design, fill, and scale transformational experiences."'],
    // OG
    ['content="Vibe Rise — The App That Gamifies Courage"', 'content="Scale — Where Experience Creators Grow"'],
    ...
    ['content="Vibe Rise — The App That Gamifies Courage"', 'content="Scale — Where Experience Creators Grow"'],
    // Apple
    ['content="Vibe Rise"', 'content="Scale"'],
    // JSON-LD: swap all remaining Vibe Rise refs
    [/"name": "Vibe Rise"/g, '"name": "Scale"'],
    ...
    ['The app that gamifies courage. Safety × Expression = experiences you love. Stack enough and you have a life you love.',
     'Where experience creators grow. Design, fill, and scale transformational experiences.'],
    ['The app that gamifies courage. Safety × Expression = experiences you love.',
     'Where experience creators grow. Design, fill, and scale transformational experiences.'],
    ...
    [/<script type="application\/ld\+json">\s*\{\s*"@context":\s*"https:\/\/schema\.org",\s*"@type":\s*"FAQPage"[\s\S]*?<\/script>/,
     ''],
    // Splash screen
    [/<span class="word-vibe">VIBE<\/span>\s*\n?\s*<span class="word-rise">RISE<\/span>/,
     '<span class="word-vibe" style="font-size:2.4rem;letter-spacing:4px">SCALE</span>'],
  ]
