...
export const PAGE_CONTENT = {
  ...
  '/shadow-work': {
    ...
    faq: {
      ...
      how_often: `Once per calendar week (Monday to Sunday). Each session builds on previous ones, and you'll explore different shadows each time, building a growing inventory of self-knowledge.\n\nThe goal isn't to "finish" shadow work. It's to keep peeling back layers as you grow.`,
  ...
  'mindspace_existing_biz': {
    ...
    whatIsThis: `You chose "Build something of my own", and now we're asking if you already have something in motion, or if you're starting fresh. This determines whether we connect your Mind Space discoveries to an existing business or help you build from scratch.`,
  ...
  'mindspace_stage': {
    ...
    whatIsThis: `You have an existing business, so now tell us where you are with it. This unlocks stage-specific quests and tools in the 7-Day Challenge.\n\nPick whichever stage feels most accurate right now.`,
