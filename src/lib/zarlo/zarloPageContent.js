...
export const PAGE_CONTENT = {
  ...
  '/me': {
    pageId: 'profile_page',
    pageName: 'Profile',
    whatIsThis: `Your home base — see your points, streak, stage progress, and quick access to key flows. This is mission control for your FindMyFlow journey.`,
  ...
  default: {
    pageId: 'default',
    pageName: 'FindMyFlow',
    whatIsThis: `You're exploring FindMyFlow — a system designed to help you build something that aligns with who you actually are, not who you think you should be.`,
    whyMatters: `Every piece of FindMyFlow is designed to help you work WITH your nervous system instead of fighting against it. If you're unsure why you're here or what to do next, I've got you.`,
    contextualPrompts: [
...
export const PUBLIC_VALIDATION_CONTENT = {
  ...
  completionCTA: {
    ...
    ctaDescription: 'FindMyFlow helps people discover what they\'re meant to build and actually make it happen — by working WITH their nervous system instead of fighting against it.',
    ctaButton: 'Check out FindMyFlow →',
    ctaLink: '/'
  }
}
