...
// Backwards-compat: map old v1 + v2 problem ids to current v3 ids.
// v1 ids (from original competence wheels) and v2 ids (poetic names)
// both resolve to the current 12 market-aligned segments.
export const LEGACY_PROBLEM_ID_MAP = {
  // v1 → current
  physical_vitality: 'pain_not_believed',
  mental_wellbeing: 'feeling_lost',
  personal_mastery: 'feeling_stupid',
  intimate_bonds: 'lonely_disconnected',
  service_care: 'lonely_disconnected',
  creative_expression: 'work_treated_nothing',
  local_impact: 'lonely_disconnected',
  cultural_movements: 'minds_hurting',
  economic_freedom: 'work_hollows',
  social_justice: 'people_treated_unfairly',
  planetary_health: 'world_losing',
  human_progress: 'feeling_stupid',
  // v2 → current (removed segments mapped to replacements)
...
export const PROBLEM_SEGMENTS = [
  ...
  },
  {
    ...
    recognitionPhrases: [
      ...
      "You've walked through something dark and came back with a map",
      "You help people find themselves when they've lost who they are",
    ],
    color: '#673AB7',
    icon: '🧠',
    placemakes: [
  ...
  },
  {
    ...
    recognitionPhrases: [
      ...
      "You believe nobody should be stressed about money because nobody taught them",
      "You help people take control of money instead of money controlling them",
    ],
    color: '#FF8E53',
    icon: '💰',
    placemakes: [
      'Pretending you understand money because nobody taught you and you\'re too ashamed to ask',
      'Working full-time and still not being able to pay rent',
      'Watching debt grow while the people who lend it get richer',
      'Being one emergency away from losing everything',
      'The gap between what you earn and what a life costs getting wider every year',
    ],
  },
  {
    ...
    recognitionPhrases: [
      ...
      "You build spaces where people finally feel like they belong",
      "You help people find their people",
    ],
    color: '#00BCD4',
    icon: '🫂',
    placemakes: [
      'Having hundreds of online connections and nobody to call at 2am',
      ...
      'Being asked to prove you deserve the basics before anyone will sit with you',
    ],
  },
  {
    id: 'feeling_stupid',
  ...
  },
  {
    ...
    recognitionPhrases: [
      ...
      "You know most workplace problems are leadership problems",
      "You fix the room, not just the person",
    ],
    color: '#4D96FF',
    icon: '🏢',
    placemakes: [
      'A team full of talent producing nothing because nobody knows how to lead them',
      'Meetings that drain everyone and decide nothing',
      'Good people leaving not because of the work but because of the boss',
      'Organizations growing so fast they forget why they started',
      'Leaders promoted for results, not for how they treat people',
    ],
  },
  {
    id: 'world_losing',
...
export const DOMAIN_FEATURE_MAP = {
  kids_deserved_better: ['learning', 'tracking', 'community', 'accountability'],
  pain_not_believed: ['tracking', 'analysis', 'accountability', 'planning'],
  minds_hurting: ['tracking', 'learning', 'accountability', 'community'],
  money_stress: ['analysis', 'planning', 'learning', 'tracking'],
  lonely_disconnected: ['matching', 'communication', 'community', 'planning'],
  feeling_stupid: ['learning', 'creation', 'community', 'analysis'],
  work_treated_nothing: ['creation', 'community', 'matching', 'learning'],
  work_hollows: ['matching', 'planning', 'learning', 'community'],
  teams_leaders_broken: ['analysis', 'planning', 'communication', 'accountability'],
  world_losing: ['tracking', 'community', 'analysis', 'learning'],
  people_treated_unfairly: ['community', 'communication', 'matching', 'creation'],
  feeling_lost: ['learning', 'tracking', 'accountability', 'matching'],
};
