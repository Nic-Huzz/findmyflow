...
export default function FlowFinderSkills() {
  ...
  const mapClusterToSegments = (clusterLabel) => {
    ...
    const segmentMappings = {
      // Direct matches (0=storytelling, 1=teaching, 2=coaching, 3=performing, 4=creating, 5=building, 6=designing, 7=leading, 8=connecting, 9=speaking_up)
      storytelling: [0], narrative: [0], memoir: [0], 'content writing': [0], journal: [0],
      ...
      'speaking up': [9], advocacy: [9], activism: [9], 'truth telling': [9], courage: [9],
      // Absorbed terms
