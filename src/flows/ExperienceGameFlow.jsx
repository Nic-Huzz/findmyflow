...
const EXPERIENCE_DESC = {
  ...
  'exp-choosing-style': 'Streetwear, vintage, sustainable brands, capsule wardrobes, expressing yourself through clothes',
  ...
  'sub-proptech-2020': 'Knocking down walls, tiling, building shelves, hands-on construction',
  ...
  'media-1954': 'Guitar, piano, drums, DJ, making music',
  'exp-singing': 'Karaoke, choir, open mic, singing solo or with others',
  'exp-rapping': 'Freestyle, writing bars, battle rap, recording tracks',
  'exp-teaching': 'Running workshops, teaching a class, tutoring, facilitating groups',
  'exp-djing-live': 'Club sets, festival stages, house parties, silent discos',
  'exp-dance-expression': 'Choreography, dance class, freestyle, partner dance, performances',
  'exp-interior-design': 'Room layouts, renovations, styling spaces, hospitality design',
  'exp-fashion-design': 'Clothing, accessories, sustainable fashion, costume design',
  'exp-product-design': 'UX, web design, industrial design, game design',
  'exp-graphic-design': 'Brand identity, posters, packaging, illustration, typography',
  'exp-investing': 'Stocks, crypto, property, angel investing, day trading',
  'exp-spreadsheets': 'Financial models, dashboards, tracking systems, formulas',
  'exp-caring-kids': 'Playing with kids, bedtime stories, sports days, homework help',
  'exp-baking': 'Bread, sourdough, cakes, pastries, baking for others',
  'exp-travel': 'City breaks, road trips, solo travel, cultural immersion',
  'exp-puzzles': 'Escape rooms, jigsaws, crosswords, murder mysteries, brain teasers',
  'exp-acting': 'Improv, community theatre, acting class, film, sketch comedy',
  'exp-creative-writing': 'Fiction, poetry, screenwriting, songwriting, essays, blogging',
  'exp-cycling': 'Road cycling, mountain biking, commuting, gravel, Peloton',
  'exp-skiing': 'Resort skiing, snowboarding, backcountry, cross-country, terrain park',
  'exp-fishing': 'Fly fishing, sea fishing, freshwater, shore, spearfishing',
  'exp-horse-riding': 'Trail riding, dressage, show jumping, western, equine therapy',
