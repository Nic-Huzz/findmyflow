      ...
      <div className="lets-play-flow flow-base">
        <div className="flow-content">
          <div className="prereq-message">
            ...
            <h2>No Plays to Review</h2>
            <p>Complete a Let's Play quest first, then come back to reflect on your experience.</p>
    ...
    return (
      <div className="lets-play-flow flow-base">
        <div className="welcome-container">
          ...
          <h1 className="welcome-greeting">Review Your Play</h1>
