...
const DIMENSIONS = [
  ...
  },
  {
    ...
    name: 'Engagement',
    emoji: '🔥',
    question: 'How excited are you by the activities in your life, not just the outcomes?',
    low: 'Going through the motions. The process feels like a chore you tolerate for the result.',
    high: 'The process itself lights you up. You would do it even if nobody was watching.',
    anchors: ['Just going through the motions', 'Mostly grinding', 'Some parts light me up', 'Mostly excited by what I do', 'The process itself is the reward'],
  },
  {
    id: 'joy',
    name: 'Joy',
