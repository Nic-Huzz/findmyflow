...
const getEssenceMessage = (voice, layer) => {
  const messages = {
    ...
    'auto_pilot_screen': 'Your Auto-Pilot says it doesn\'t matter. But your ideas deserve to reach people.',
    'auto_pilot_live': 'Your Auto-Pilot can\'t find the energy. But one small launch can reignite everything.',
        ...
        <div className="lr-section">
          ...
          {salesData.hasPage === 'no' && (
            <div className="lr-info-box warning">
              ...
              <p>Options: Find My Flow CRM (includes checkout pages), a direct checkout link, booking page, or a full sales page.</p>
            </div>
          )}
