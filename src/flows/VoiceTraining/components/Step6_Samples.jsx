/**
 * Step 6: Content Samples
 * Optional - paste in existing content for voice analysis
 */
import { useState } from 'react'

export default function Step6_Samples({ samples, onChangeSamples, onContinue, onSkip }) {
  ...
  return (
    <div className="vt-step">
      <div className="vt-step-header">
        <h2>Share your existing content</h2>
        <p>
          Paste 1-3 pieces of content you&apos;ve written (social posts, emails, captions).
          This helps us learn your actual voice - not just how you describe it.
        </p>
      </div>
      ...
      <div className="vt-tip">
        ...
        <div className="vt-tip-content">
          <strong>Best results:</strong> Share content where you felt &quot;in flow&quot; -
          pieces that sound most like you. The more samples, the better we can capture your voice.
        </div>
      </div>
      ...
      >
        {canContinue ? 'Analyze My Voice →' : 'Add at least 1 sample (100+ chars)'}
      </button>
      ...
      <button
        ...
        onClick={onSkip}
      >
        Skip - Generate from answers only
      </button>
    </div>
  )
}
