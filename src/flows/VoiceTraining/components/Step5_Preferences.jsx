 ...
 * Sliders for style dimensions + catchphrases input
 */
...
export default function Step5_Preferences({ preferences, catchphrases, onChangePreferences, onChangeCatchphrases, onContinue }) {
  ...
  return (
    <div className="vt-step">
      <div className="vt-step-header">
        <h2>Fine-tune your style</h2>
        <p>
          Adjust these sliders to match how you naturally communicate.
      ...
      <div className="vt-step-header" style={{ marginTop: '24px' }}>
