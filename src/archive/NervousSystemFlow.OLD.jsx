...
function formatMarkdown(text) {
  ...
  return text
    ...
    // YouTube embeds: Convert youtube.com/watch?v= and youtu.be/ links to iframes
    .replace(/https:\/\/(?:www\.)?youtube\.com\/watch\?v=([a-zA-Z0-9_-]+)/g,
      '<div style="margin: 24px 0; border-radius: 12px; overflow: hidden; background: rgba(0,0,0,0.3);"><iframe src="https://www.youtube.com/embed/$1" width="100%" height="400" frameborder="0" allowfullscreen style="display: block;"></iframe></div>')
