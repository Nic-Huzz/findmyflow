  ...
  matchups: [
    {
      ...
      calculated: false,
      categories: [
        { key: 'business_efficiency', aScore: 38, bScore: 25 },
        { key: 'play_list', aScore: 12, bScore: 18 },
        { key: 'healing', aScore: 22, bScore: 14 },
        { key: 'voice', aScore: 8, bScore: 15 },
    ...
    },
    {
      ...
      calculated: false,
      categories: [
        { key: 'business_efficiency', aScore: 15, bScore: 30 },
        { key: 'play_list', aScore: 20, bScore: 22 },
        { key: 'healing', aScore: 28, bScore: 10 },
        { key: 'voice', aScore: 5, bScore: 18 },
    ...
    },
    {
      ...
      calculated: false,
      categories: [
        { key: 'business_efficiency', aScore: 20, bScore: 20 },
        { key: 'play_list', aScore: 16, bScore: 10 },
        { key: 'healing', aScore: 12, bScore: 18 },
        { key: 'voice', aScore: 6, bScore: 22 },
        { key: 'bonus', aScore: 14, bScore: 8 },
      ],
    },
  ],
}
