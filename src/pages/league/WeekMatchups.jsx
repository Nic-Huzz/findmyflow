  ...
  matchups: [
    {
      ...
      calculated: false,
      categories: [
        { key: 'tune', aScore: 12, bScore: 18 },
        { key: 'courage', aScore: 22, bScore: 14 },
        { key: 'reach', aScore: 20, bScore: 10 },
      ],
    },
    {
      id: 'm2',
      ...
      calculated: false,
      categories: [
        { key: 'tune', aScore: 20, bScore: 22 },
        { key: 'courage', aScore: 18, bScore: 24 },
        { key: 'reach', aScore: 8, bScore: 25 },
      ],
    },
    {
      id: 'm3',
      ...
      calculated: false,
      categories: [
        { key: 'tune', aScore: 16, bScore: 10 },
        { key: 'courage', aScore: 12, bScore: 18 },
        { key: 'reach', aScore: 14, bScore: 14 },
      ],
    },
  ],
}
