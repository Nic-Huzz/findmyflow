/**
 * ExperienceCatalog — LEGACY
 *
 * No longer rendered at any route. /create now uses CreatorHome.
 * Kept for reference. ExperienceCreate and ExperienceDetail are still active.
 */
