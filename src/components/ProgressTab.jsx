...
const HERO_STAGES = [
  ...
  { stage: 8, name: 'The Ordeal', refs: ['Mufasa\'s death breaking Simba open.', 'Tony Stark snapping the Infinity Gauntlet.', 'Neo dying and coming back as The One.'], nextTitle: 'Find your direction', nextHow: 'Go to the Discover tab and work through the Direction cards. Review your story, find the problem that drives you, and see your career direction revealed.', route: '/7-day-challenge?tab=discover' },
  { stage: 9, name: 'Reward', refs: ['Simba taking his place on Pride Rock.', 'Thor finally becoming worthy.', 'Frodo holding the ring at Mount Doom.'], nextTitle: 'Grow consistent income', nextHow: 'You earned your first dollar from what you love. Keep showing up, refining your offer, and serving your people.', route: '/create' },
  { stage: 10, name: 'The Road Back', refs: ['Woody choosing to leave Andy.', 'Spider-Man returning to Queens.', 'Bilbo writing his book.'], nextTitle: 'Cover your living expenses', nextHow: 'You\'ve been earning consistently for 3+ months. Set your expenses target and work toward covering them.' },
