...
export const CAPABILITIES = [
  ...
  { id: 'email_nurture', triggers: ['nurture'], canAI: 'Yes, fully', level: 4, levelLabel: 'One-click', levelIcon: 'green',
  ...
  { id: 'triggered_email', triggers: ['email_auto'], canAI: 'Yes, with setup', level: 4, levelLabel: 'One-click', levelIcon: 'green',
    title: 'Set up automated email sequences', bestTool: 'Claude (writes) + Kit (sends on triggers)', altTools: 'Mailchimp, ActiveCampaign, Resend',
    youDo: 'Write the sequences once, then they run on autopilot', setup: '1-2 hrs', cost: 'Free-$29/mo', taaftSlug: 'email' },
