...
export const CAPABILITIES = [
  ...
  { id: 'ig_autopost', triggers: ['social_grow', 'social_posts', 'content_auto'], canAI: 'Yes, fully', level: 5, levelLabel: 'Runs itself', levelIcon: 'green',
  ...
  { id: 'repurpose', triggers: ['video', 'content_auto'], canAI: 'Yes, fully', level: 5, levelLabel: 'Runs itself', levelIcon: 'green',
  ...
  { id: 'schedule_posts', triggers: ['social_posts', 'content_auto', 'social_grow'], canAI: 'Yes, fully', level: 5, levelLabel: 'Runs itself', levelIcon: 'green',
