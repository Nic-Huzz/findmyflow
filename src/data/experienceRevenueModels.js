...
export const EXPERIENCE_REVENUE_MODELS = {
  ...
  'Investing / trading':                      ['coaching_packages', 'ad_sponsorship'],
  ...
  'Volunteering / giving back':               ['wage', 'coaching_packages'],
  ...
  'Intentional napping':                      ['coaching_packages'],
