/**
 * Flow Scrolls - Core teachings of the Find My Flow philosophy
 *
...
export const FLOW_SCROLLS = [
  // ============================================
  // THE FOUR DIRECTIONS
  // ============================================
  {
    id: 'scroll_four_directions',
    category: 'flowScrolls',
    title: 'The Four Directions',
    icon: '🧭',
    order: 1,
    unlockTrigger: UNLOCK_TRIGGERS.COMPASS_CHECKIN,
    unlockValue: 1,

    content: {
      teaching: {
        title: 'The Teaching',
        body: `Your energy speaks a language. The Flow Compass translates it.
...
The compass doesn't judge. It observes. Your job is to listen.`,
      ...
      matters: {
        ...
        body: `Most people treat all resistance the same: something to push through. But resistance when you're excited (East) is completely different from resistance when you're tired (South).
...
Flow isn't about eliminating resistance. It's about knowing which direction you're facing—and acting accordingly.`,
      ...
      practice: {
        title: 'The Practice',
        body: `Check in regularly. Ask yourself:
...
*"The wise person doesn't fight the current. They learn to read it."*`,
      },
    },
  },
  ...
  // ============================================
  {
    id: 'scroll_flow_equation',
    category: 'flowScrolls',
    title: 'The Flow Equation',
    icon: '✨',
    order: 2,
    ...
    content: {
      teaching: {
        title: 'The Teaching',
        body: `Your Flow isn't random. It's mathematical.
...
This is your competitive advantage disguised as joy.`,
      },

      matters: {
        title: 'Why This Matters',
        body: `The Matrix taught you to separate these three:
...
Your Flow already exists. The Flow Finder just helped you see it.`,
      },

      practice: {
        title: 'The Practice',
        body: `Return to your Flow Equation when you feel lost:
...
*"Your Flow is unique because YOU are unique. No one else has your equation."*`,
      },
    },
  },
  ...
  // ============================================
  {
    id: 'scroll_groan_decoded',
    category: 'flowScrolls',
    title: 'The Groan Decoded',
    icon: '😬',
    order: 3,
...
The Groan is the collision of desire and fear. It's not a stop sign. It's a "this matters" sign.`,
      },

      matters: {
        title: 'Why This Matters',
        body: `Most people misread the Groan. They feel the resistance and think: "I must not want this" or "This isn't for me."
...
*"The Groan is the sound of your comfort zone stretching. It means you're growing."*`,
  ...
  // ============================================
  {
    id: 'scroll_visibility_ladder',
    category: 'flowScrolls',
    title: 'The Visibility Ladder',
    icon: '🪜',
    order: 4,
    ...
    content: {
      teaching: {
        title: 'The Teaching',
        body: `Visibility isn't binary. It's a ladder with five rungs.
...
Each rung you climb doesn't just increase your visibility—it increases your ownership of your identity. You're not just being seen more; you're claiming who you are more fully.`,
      ...
      practice: {
        title: 'The Practice',
        body: `Assess your current position on the ladder:
...
*"The ladder isn't about being seen by more people. It's about being seen as more fully yourself."*`,
      },
    },
  },
  ...
  // ============================================
  {
    ...
    content: {
      teaching: {
        title: 'The Teaching',
        body: `You don't manage time. You manage energy.
...
You're not trying to always be in North. You're trying to flow between states intentionally, extracting value from each phase of the cycle.`,
      },

      matters: {
        title: 'Why This Matters',
        body: `The Matrix taught you that energy is unlimited and willpower is the answer. "Just push through." "Sleep is for the weak." "Hustle harder."
...
You can't control how much time you have. You can control how you spend your energy.`,
      },

      practice: {
        title: 'The Practice',
        body: `Start noticing your patterns:
...
*"The alchemist doesn't create energy from nothing. They transform what's available into what's needed."*`,
      },
    },
  },
  ...
  // ============================================
  {
    id: 'scroll_play_as_portal',
    category: 'flowScrolls',
    title: 'Play as Portal',
    icon: '🎮',
    order: 6,
    unlockTrigger: UNLOCK_TRIGGERS.PLAYGROUND_COUNT,
    unlockValue: 10,
...
The play you've been denying yourself? That's the portal to your Flow. The things you dismissed as "not serious enough"? Those are clues to your unique gift.`,
      },
...
*"The master has failed more times than the beginner has tried. And the master was playing the whole time."*`,
  ...
  // ============================================
  {
    id: 'scroll_service_threshold',
    category: 'flowScrolls',
    title: 'The Service Threshold',
    icon: '🚪',
    order: 7,
    unlockTrigger: UNLOCK_TRIGGERS.STAGE_REACHED,
    unlockValue: 6,
    ...
    content: {
      teaching: {
        title: 'The Teaching',
        body: `There's a moment in every hero's journey where discovery ends and service begins.
...
Discovery without service is self-indulgence. Service without discovery is burnout. The hero's journey includes both.`,
      ...
      practice: {
        title: 'The Practice',
        body: `Signs you're ready to cross the threshold:
...
*"You don't wait until you're healed to help others. The helping IS the healing."*`,
      },
    },
  },

  // ============================================
  // THE PROTECTIVE BARGAIN
  // ============================================
  {
    id: 'scroll_protective_bargain',
    category: 'flowScrolls',
    title: 'The Protective Bargain',
    icon: '🤝',
    order: 8,
    ...
    content: {
      teaching: {
        title: 'The Teaching',
        body: `Your Protective Voices didn't appear to limit you. They appeared to save you.
...
But the environment changed. You grew up. You left. And the Protective Voice... didn't get the memo.`,
      },

      matters: {
        title: 'Why This Matters',
        body: `Understanding the bargain changes how you relate to your Protective Voice.
...
This isn't weakness. It's evolution. The protection that saved child-you is limiting adult-you. Time to renegotiate.`,
      },

      practice: {
        title: 'The Practice',
        body: `Have the conversation with your Protective Voice:
