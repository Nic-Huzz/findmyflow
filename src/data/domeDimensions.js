...
export const DOME_DIMENSIONS = [
  ...
  },
  {
    ...
    label: 'Vulnerability',
    icon: '💜',
    question: 'How visible were you?',
    startQuestion: 'How visible are you on this path?',
    dreamQuestion: 'How visible would you need to be?',
    type: 'qualitative',
    maxLevel: 5,
    levels: [
      { level: 1, label: 'Not visible yet', description: 'Haven\'t put myself out there' },
      { level: 2, label: 'Behind the scenes', description: 'Name attached but behind structure' },
      { level: 3, label: 'Face on screen', description: 'On camera but behind a screen' },
      { level: 4, label: 'Face in person', description: 'In person, people can see you' },
      { level: 5, label: 'Nothing to hide behind', description: 'No professional context, just you' },
    ],
  },
  {
    id: 'stakes',
  ...
  },
  {
    ...
    label: 'Context',
    icon: '🧭',
    question: 'How far outside your comfort zone were the conditions?',
    startQuestion: 'How familiar are the conditions on this path?',
    ...
    levels: [
      { level: 1, label: 'Not at all', description: 'Haven\'t left familiar territory' },
      { level: 2, label: 'One new thing', description: 'Mostly familiar, one new variable' },
      { level: 3, label: 'Half and half', description: 'Some things familiar, some not' },
      { level: 4, label: 'Mostly unfamiliar', description: 'Multiple new factors stacking' },
      { level: 5, label: 'Everything was new', description: 'Different place, people, norms, no safety net' },
    ],
  },
  {
