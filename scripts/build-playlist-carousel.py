"""
Carousel: What is your Play-List? (4 slides)
"""
from pathlib import Path

ROOT = Path(__file__).resolve().parent.parent
OUTPUT = ROOT / "public" / "images" / "carousel" / "playlist-draft.html"
...
<div class="slide" style="position:relative;width:420px;height:525px;flex-shrink:0;{PURPLE_BG}overflow:hidden;">
  <div style="position:relative;z-index:2;width:100%;height:100%;display:flex;flex-direction:column;justify-content:center;padding:0 36px;color:#fff;">
    <h1 class="serif" style="font-size:28px;font-weight:600;line-height:1.15;letter-spacing:-0.5px;margin:0;max-width:360px;">
      Easiest way to answer the question:<br/><br/>
      <span style="color:{GOLD};">"What do you want to be when you grow up?"</span>
    </h1>
  </div>
  {swipe_arrow()}
  {progress_bar(0)}
...
<div class="slide" style="position:relative;width:420px;height:525px;flex-shrink:0;{PURPLE_BG}overflow:hidden;">
  <div style="position:relative;z-index:2;width:100%;height:100%;display:flex;flex-direction:column;justify-content:center;padding:0 36px;color:#fff;">
    <h2 class="serif" style="font-size:28px;font-weight:600;line-height:1.15;letter-spacing:-0.5px;margin:0;max-width:360px;">
      What <span style="color:{GOLD};">experiences</span> do you want to have?
    </h2>
  </div>
  {swipe_arrow()}
  {progress_bar(1)}
...
<div class="slide" style="position:relative;width:420px;height:525px;flex-shrink:0;{PURPLE_BG}overflow:hidden;">
  <div style="position:relative;z-index:2;width:100%;height:100%;display:flex;flex-direction:column;justify-content:center;padding:0 36px;color:#fff;">
    <p class="sans" style="font-size:13px;color:rgba(255,255,255,0.5);margin:0 0 14px;">
      But how do you identify what experiences you want to have?
    </p>
    <h2 class="serif" style="font-size:30px;font-weight:600;line-height:1.15;letter-spacing:-0.5px;margin:0;max-width:360px;">
      What do you find <span style="color:{GOLD};">fun?</span>
    </h2>
  </div>
  {swipe_arrow()}
  {progress_bar(2)}
...
def slide_4():
    diagram = f'''
    <svg viewBox="0 0 420 280" style="width:100%;margin:16px auto 0;">
      <!-- Two circles overlapping -->
      <circle cx="145" cy="140" r="115" fill="rgba(233,162,59,0.1)" stroke="{GOLD}" stroke-width="2" stroke-opacity="0.4"/>
      <circle cx="275" cy="140" r="115" fill="rgba(52,152,219,0.1)" stroke="#3498db" stroke-width="2" stroke-opacity="0.4"/>

      <!-- Labels -->
      <text x="100" y="130" text-anchor="middle" fill="{GOLD}" font-family="Outfit,sans-serif" font-size="16" font-weight="700">Engagement</text>
      <text x="100" y="155" text-anchor="middle" fill="rgba(255,255,255,0.4)" font-family="Outfit,sans-serif" font-size="12">What absorbs you</text>

      <text x="320" y="130" text-anchor="middle" fill="#3498db" font-family="Outfit,sans-serif" font-size="16" font-weight="700">Joy</text>
      <text x="320" y="155" text-anchor="middle" fill="rgba(255,255,255,0.4)" font-family="Outfit,sans-serif" font-size="12">What lights you up</text>

      <!-- Center -->
      <text x="210" y="132" text-anchor="middle" fill="#fff" font-family="Fraunces,Georgia,serif" font-size="20" font-weight="600">Fun</text>
      <text x="210" y="156" text-anchor="middle" fill="rgba(255,255,255,0.5)" font-family="Outfit,sans-serif" font-size="11">Your play-list</text>
    </svg>
    '''
...
<div class="slide" style="position:relative;width:420px;height:525px;flex-shrink:0;{PURPLE_BG}overflow:hidden;">
  <div style="position:relative;z-index:2;width:100%;height:100%;display:flex;flex-direction:column;justify-content:center;padding:0 36px;color:#fff;">
    <h2 class="serif" style="font-size:28px;font-weight:600;line-height:1.15;letter-spacing:-0.5px;margin:0 0 8px;max-width:360px;">
      Fun = <span style="color:{GOLD};">Engagement</span> + <span style="color:#3498db;">Joy</span>
    </h2>
    <p class="sans" style="font-size:13px;color:rgba(255,255,255,0.6);margin:0;">
      That's your play-list.
    </p>
    {diagram}
  </div>
  {progress_bar(3)}
...
<title>What is your Play-List?</title>
